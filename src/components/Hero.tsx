...
export const Hero = () => {
  return (
    <div className="w-full max-w-[1280px] mx-auto grid grid-row-2 px-3 ">
      <div className="flex flex-col lg:flex-row justify-center items-center md:justify-between mt-16 md:mt-32">
        {/* statement */}
        <div className="mt-10 shrink text-center lg:text-left lg:w-1/2 h-34">
      ...
      {/* scrollable button */}
      <button className="flex justify-center md:justify-start mt-10 mb-16 md:mt-20 md:mb-24 stroke-1 cursor-pointer ">
        <ArrowDownIcon className="w-12 h-8 transform transition duration-500 hover:scale-125" />
      </button>
    </div>
  );
};
